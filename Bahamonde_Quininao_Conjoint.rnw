...
<<density:plot:w:p, echo = FALSE, fig.pos='H', warning = FALSE, message = F, fig.cap=density.plot.w.p.note, fig.align='center', fig.width=4, fig.height=2,dpi=1000,cache=FALSE, include = TRUE>>=
