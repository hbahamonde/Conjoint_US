...
\title{\href{https://github.com/hbahamonde/Conjoint_US/raw/master/Bahamonde_Quininao_Conjoint.pdf}{\input{title.txt}\unskip}}


\author{Hector Bahamonde \inst{$\star$} \and Cristobal Quininao \inst{$\star$}}
\institute{\inst{$\star$} Universidad de O$'$Higgins 
%\and
